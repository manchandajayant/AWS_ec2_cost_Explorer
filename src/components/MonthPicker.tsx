                    ...
                    {months.map((m, i) => {
                        ...
                        return (
                            <button
                                ...
                                type="button"
                                onClick={() => onSelect(i)}
                                className={`py-2 text-sm rounded-lg border transition-colors ${isSelected ? "bg-gray-200 text-gray-900 border-gray-300" : "bg-white text-gray-700 hover:bg-gray-50 border-gray-200"}`}
                            >
                                {m.slice(0, 3)}
                            </button>
                        );
